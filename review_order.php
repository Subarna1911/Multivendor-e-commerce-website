...
<?php echo $type_name; ?>: <span class="text-muted"> INR<?php echo $shipping_cost; ?> </span> 
...
<th class="total-shipping-price">INR<?php echo $total_cart_price; ?>.00</th>

<?php }else{ ?>

<th class="total-shipping-price">INR<?php echo $total; ?>.00</th>
...
$(".total-shipping-price").html("INR" + total_cart_price + ".00");
