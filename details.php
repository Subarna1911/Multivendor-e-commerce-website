...
Product Price : <del> INR $pro_price </del><br>

Product Sale Price : INR $pro_psp_price
...
Bundle Price : <del> INR $pro_price </del><br>

Bundle Sale Price : INR $pro_psp_price
...
echo " Product Price : INR$variation_product_price ";
	
}else{

echo "

Product Price : <del> INR$variation_product_price </del><br>

Product Sale Price : INR$variation_product_psp_price
...
echo " Bundle Price : INR$variation_product_price ";
	
}else{

echo "

Bundle Price : <del> INR $variation_product_price </del><br>

Bundle Sale Price : INR $variation_product_psp_price
...
$product_price = "<del> INR$pro_price </del>";

$product_psp_price = "| INR$pro_psp_price";
...
$product_price = "INR$minimum_product_price - INR$maximum_product_price";
